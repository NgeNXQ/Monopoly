...
internal sealed class PanelChancePaymentUI : MonoBehaviour, IActionControlUI
{
    [Header("Visuals")]
    ...
    internal static PanelChancePaymentUI Instance { get; private set; }
    ...
    private void Awake()
    {
        if (PanelChancePaymentUI.Instance != null)
            throw new System.InvalidOperationException($"Singleton {this.GetType().FullName} has already been initialized.");

        PanelChancePaymentUI.Instance = this;
    }
    ...
    {
        this.PanelDialogResult = PanelChancePaymentUI.DialogResult.Confirmed;
