...
public sealed class NodeTouchHandlerUI : MonoBehaviour, IPointerClickHandler
{
    ...
    public void OnPointerClick(PointerEventData eventData = null)
    {
        ...
        UIManager.Instance.PanelMonopolyNode.PictureSprite = this.monopolyNode.NodeSprite;
        UIManager.Instance.PanelMonopolyNode.MonopolyTypeColor = this.monopolyNode.AffiliatedMonopoly.ColorOfSet;
