    ...
    internal sealed class TradeSenderPanel : MonoBehaviour, ICallableAction, IPointerClickHandler
    {
        ...
        internal TradeCredentialsSerializable Credentials
        {
            get
            {
                ...
                int senderNodeIndex = this.SenderTile == null ? TradeCredentialsSerializable.PLACEHOLDER : MonopolyBoard.Instance.GetIndexOfTile(this.SenderTile);
                int receiverNodeIndex = this.ReceiverTile == null ? TradeCredentialsSerializable.PLACEHOLDER : MonopolyBoard.Instance.GetIndexOfTile(this.ReceiverTile);
