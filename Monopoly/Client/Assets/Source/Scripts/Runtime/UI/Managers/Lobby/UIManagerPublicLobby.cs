...
{
    internal sealed class UIManagerPublicLobby : MonoBehaviour
    {
        ...
        internal static UIManagerPublicLobby Instance { get; private set; }
        ...
        private void Awake()
        {
            if (UIManagerPublicLobby.Instance != null)
                throw new TypeInitializationException(nameof(UIManagerPublicLobby), new ApplicationException($"Singleton has already been initialized."));

            UIManagerPublicLobby.Instance = this;
        }
        ...
        {
            PlayerUnrankedLobbyView newPanel = PublicLobbyPlayerViewsPool.Instance?.GetInactiveObject();
