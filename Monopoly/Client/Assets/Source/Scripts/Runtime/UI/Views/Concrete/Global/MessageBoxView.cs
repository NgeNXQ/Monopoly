...
namespace Monopoly.Client.Runtime.UI.Views.Concrete.Global
{
    internal sealed class MessageBoxView : MonoBehaviour, IView, IViewCallableAction, IViewCallableState
    {
        ...
        {
            this.PanelDialogResult = MessageBoxView.DialogResult.OK;
        ...
        {
            this.PanelDialogResult = MessageBoxView.DialogResult.Cancel;
            this.actionsHandler?.Invoke();
            this.Hide();
        }
        ...
        {
            if (this.MessageBoxType == MessageBoxView.Type.None)
                this.Hide();
        }
